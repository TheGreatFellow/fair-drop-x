...
export const DROP_ADDRESS = "0x897d36a3d028776c3cdfc2e5a468544fdd1eb9d3" as const;
...
export const dropAbi = [
  {
    ...
    "inputs": [
      ...
      },
      {
        "name": "c",
        "type": "tuple",
        "internalType": "struct Drop.Config",
        "components": [
          {
            "name": "maker",
            "type": "address",
    ...
    "inputs": [
      {
        "name": "v",
        "type": "tuple",
        "internalType": "struct Drop.Voucher",
        "components": [
          {
            "name": "dropId",
            "type": "bytes32",
